...
<img src="img/gold-light/buttons-off.png" width="284" alt="Two buttons disabled, the fills flattened and the labels in the faintest text, then one that stays pressed in the accent tint, and the small size">
</picture>
