...
in the middle of it. The strip under the thin half has no colour of its own:
it is whatever is under the bar, measured. Under the band the HWND carries a
...
<img src="docs/img/gold-light/titlebar-mark.png" width="276" alt="The mark on the band inside a round disc in the accent tint, with the mark itself turned accent: how it looks under the pointer">
</picture>
...
<img src="docs/img/gold-light/more.png" width="91" alt="Two panel rows, each with a small round question mark beside the label; the second one is lit in the accent because its sheet is the one open">
</picture>
</td>
<td align="center" valign="middle">
<picture>
...
the system's opening animation, as sharp in its first frame as in its last. [The window](docs/window.md) has the whole of it.
...
A full run is 334 files and twenty four megabytes, and `docs/shots/` is
