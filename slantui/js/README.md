...
| `titlebar.js` | the oblique band, the window buttons, the resize strips, the credit line, the mark as a button | `initTitlebar`, `shapeTitleBar`, `setBrandAction`, `onWindowMaximized`, `roundedPolyPath`, `CREDIT_TEXT` |
