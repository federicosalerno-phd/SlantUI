...
![A window built on SlantUI: the oblique band across the top, a rail of four steps, a drawing on the stage and a side panel of controls](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/tour/gold-dark-2.png)
...
![The oblique band, with the logo and the name on the left, the credit line in the middle and the three window buttons on the right](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/titlebar.png)
...
![The step rail: four numbered steps on the left, an About button and a status pill on the right](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/steps.png)
...
![The strip of small controls over the stage, a line of hint text in the middle, the name of what is open on the right](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/toolbar.png)
...
<img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/panel.png" width="244" alt="The side panel: a title and a subtitle, a list of palettes, a paragraph, and two rows of buttons at the bottom">
...
|:---:|:---:|:---:|
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/buttons.png" width="296" alt="A gold primary button, a plain one, and a destructive one in red"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/buttons-wide.png" width="296" alt="A wide primary button over a Back and a Next"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/window-buttons.png" width="296" alt="Minimise, maximise and close"> |
| **Toolbar buttons** | **A text field** | **A number field, with its own stepper** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/toolbar-buttons.png" width="296" alt="Three small square buttons, one of them on"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/input.png" width="296" alt="A text field with a unit beside it"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/number.png" width="296" alt="A number field with an up and a down arrow inside it"> |
| **A dropdown, open** | **Sliders** | **A list to choose from** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/dropdown-open.png" width="296" alt="A dropdown with its popup open and one option selected"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/sliders.png" width="296" alt="Three sliders with their names and values"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/chooser.png" width="296" alt="Three rows with badges, the first one selected, the last one off"> |
| **Chips** | **Metric rows** | **Key and value rows** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/chips.png" width="296" alt="A plain chip, an accent chip and an error chip"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/metrics.png" width="296" alt="Two groups of measurements, each under a coloured dot, one row marked"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/rows.png" width="296" alt="Three filled rows, a name on the left and a value on the right"> |
| **A card** | **Words in a status colour** | **A note on the stage** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/card.png" width="296" alt="A card holding a sentence and a chip"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/status-words.png" width="296" alt="A sentence with the words passed, close and short in green, amber and red"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/stage-chrome.png" width="296" alt="A note in the corner of the stage and a zoom pill"> |

| The steps, in their three states | The status pill, in five |
|:---:|:---:|
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/tabs.png" width="606" alt="A step that is done, the step you are on, and one not reached"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/status-pill.png" width="606" alt="Ready, Done, Cancelled, Failed and Working, each with its own dot"> |
| **The drop zone** | **A line at the bottom, and then gone** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/drop-zone.png" width="460" alt="A large card asking for a file to be dropped on it"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/toast.png" width="250" alt="A toast over the page"> |
| **A job with a percentage** | **Work with no percentage** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/progress.png" width="320" alt="A card over the scrim with 62 per cent and a progress bar"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/spinner.png" width="317" alt="A card over the scrim with a turning ring"> |
...
|:---:|:---:|:---:|:---:|
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/buttons.png" width="296" alt="The three buttons on Gold Dark"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-light/buttons.png" width="296" alt="The three buttons on Gold Light"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/teal-dark/buttons.png" width="296" alt="The three buttons on Teal Dark"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/blue-dark/buttons.png" width="296" alt="The three buttons on Blue Dark"> |
| **Purple Dark** | **Green Dark** | **Slate Light** | **High Contrast** |
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/purple-dark/buttons.png" width="296" alt="The three buttons on Purple Dark"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/green-dark/buttons.png" width="296" alt="The three buttons on Green Dark"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/slate-light/buttons.png" width="296" alt="The three buttons on Slate Light"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/high-contrast/buttons.png" width="296" alt="The three buttons on High Contrast"> |
...
|:---:|:---:|
| <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/tour/slate-light-2.png" width="1240" alt="The example window on Slate Light, a light palette with a blue accent"> | <img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/tour/high-contrast-2.png" width="1240" alt="The example window on High Contrast, black with a yellow accent"> |
...
<img src="https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/labels.png" width="296" alt="A small label in text-4 over a sentence in text-3">
...
![The example on its last step: the panel holding metric rows, the versions the window is running on, and a paragraph with three words in status colours](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/tour/gold-dark-4.png)
...
![The gallery window: a catalogue of the widget set in the work area, the palette list in the side panel](https://raw.githubusercontent.com/federicosalerno-phd/SlantUI/main/docs/img/gold-dark/window.png)
